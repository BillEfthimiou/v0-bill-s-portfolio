...
export function DiscordCard() {
  ...
  return (
    <div className="group relative h-full overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900/50 p-6 transition-all hover:border-zinc-700 hover:bg-zinc-900/80">
      ...
      <div className="relative flex items-start justify-between">
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <span className={`absolute -bottom-0.5 -right-0.5 h-4 w-4 rounded-full border-2 border-zinc-900 ${statusColors[status]}`} />
          </div>
          <div>
      ...
      {activity && !loading && (
        <div className="relative mt-4 rounded-xl bg-zinc-800/50 p-3">
      ...
      <p className="relative mt-4 text-xs text-zinc-500">
        Replace DISCORD_USER_ID with your ID
      </p>
    </div>
  )
}
